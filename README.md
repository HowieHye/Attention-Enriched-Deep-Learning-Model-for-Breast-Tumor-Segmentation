...
* <a href="Codes/UNet.ipynb">UNet</a> [on nbviewer] - implementation of the standard U-Net model for breast tumor segmentation. The U-Net is used as a baseline model for evaluation of our approach.
